<template>
    ...
    <div class="min-h-screen flex flex-col items-center relative justify-center bg_img   login__">
      ...
      <div class="flex flex-col bg-[#474747] bg-opacity-40 z-30  text-gray-200  shadow-2xl  shadow-[#342D11]  px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-3xl w-50 max-w-xs sm:max-w-md">
        <div class="py-3 self-center ">
          <img src="@/assets/images/logo.png" alt=""  class=" w-[120px] h-auto ">
        </div>
       <div class="flex justify-center text-xl font-bold text-[#FFC827] tracking-wide">账号登录</div>
        <div class="mt-5">
          <form @click.prevent>
            ...
            <div class="flex w-full">
              <button :disabled="disableBtn" @click="Login" type="submit" :class="disableBtn ? 'bg-[#F0DE7C] opacity-40 cursor-not-allowed' : 'text-black bg-[#C78E3B]'" class="flex mt-2 items-center justify-center focus:outline-none text-white text-sm sm:text-base rounded py-2 w-full transition duration-150 ease-in">
        ...
        <span class="text-[13px] mt-2">没有帐户？点击这里
